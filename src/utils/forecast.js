...
const forecast = (latitude, longitude, callback) => {
    ...
    request({ url, json: true}, (error,{body} = {}) => {
        if(error){
            ...
            callback(undefined,'Weather: ' + body.current.weather_descriptions[0] + '. It is currently '+ body.current.temperature + ' degree Celsius out. But it feels like '+ body.current.feelslike + ' degree Celsius out.' + 'The humidity is '+ body.current.humidity + '%.')
        }
    })
}
